        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="{{ url('/manager/rents') }}" class="nav-link px-2 @yield('rents-active')">Rents</a></li>
                    <li><a href="{{ url('/manager/clients') }}" class="nav-link px-2 @yield('clients-active')">Clients</a></li>
                </ul>
